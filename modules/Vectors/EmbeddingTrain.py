...
from modules.llms.chat7b import generate_response
...
def train_adaptanet_model(num_epochs, settings_file, input_dim, hidden_dim, output_dim, num_heads, num_layers, embeddings_model):
    ...
    for epoch in range(num_epochs):
        ...
        full_response = generate_response(system_prompt, user_prompt)
...
embeddings_model = EmbeddingsModel() # Initialize your embeddings model here
